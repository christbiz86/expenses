                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="hidden-480">{$row->status_bbk}
                                    <a target="_blank" href="{site_url("accounting/showdetailbbk")}/{$row->jurnal_no}">
                                        <input type="button" value="Print Detail BBK">
                                    </a>
                                    <a href="{site_url("accounting/releasebbk")}/{$row->jurnal_no}" onclick="return confirm('Anda yakin mau Release BBK ini ?');">
