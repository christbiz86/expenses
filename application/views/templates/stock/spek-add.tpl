                ...
                <div class="tab-pane active">
                   <div class="portlet box green">
                      ...
                      <div class="portlet-body form">
                         <!-- BEGIN FORM-->
                         <form action="{site_url("stock/spekadd")}" method="post" class="form-horizontal">
                            <div class="row-fluid">
                               <div class="span6">
                                  <div class="control-group">
                                     <label class="control-label">Spesifikasi</label>
                                     <div class="controls">
                                        <input type="text" value="{ci_form_validation field='desc'}" class="m-wrap span12" placeholder="Spesifikasi" name="desc">
