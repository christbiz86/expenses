    ...
    <div class="row-fluid">
        <div class="span12"> 
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{site_url("scan")}">Data Scan</a>
                </li>
            </ul>
        ...
        <div class="span12">
            ...
            <div class="portlet box yellow">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{site_url("scan/add")}" class="btn grey"><i class="icon-pencil"></i> Tambah</a>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="{site_url("scan/excel")}">Export to Excel</a></li>
                            </ul>
                        </div>
                    </div>
                    {*<div class="tools">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="{site_url("scan/edit")}/{$row->scan_id}" onclick="return confirm('Anda yakin mau edit Dokumen ini?');">
                                        <img src="{site_url("assets/img/document_edit.png")}" width="20">
                                    </a>&nbsp;&nbsp;&nbsp;
                                    <a href="{site_url("scan/delete")}/{$row->scan_id}" onclick="return confirm('Anda yakin mau hapus Dokumen ini ?');">
