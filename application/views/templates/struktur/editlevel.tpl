    ...
    <div class="row-fluid">
       <div class="span12">
          ...
          <ul class="breadcrumb">
             ...
             <li><a href="{site_url("struktur/editlevel")}">Edit Leveling</a></li>
          </ul>
       </div>
    </div>
    <!-- END PAGE HEADER-->
                ...
                <div class="tab-pane active">
                   <div class="portlet box blue">
                      ...
                      <div class="portlet-body form">
                         <!-- BEGIN FORM-->
                         {foreach $list as $row}
                         <form action="{site_url("struktur/editlevel")}/{$row->level_id}" method="post" class="form-horizontal">
                            <input type="hidden" name="level_old" value="{$row->level_position}">
                            <div class="control-group">
                                <label class="control-label">Deskripsi</label>
                                <div class="controls">
                                    <input name="desc" type="text" value="{$row->level_desc}" placeholder="deskripsi level" class="m-wrap medium" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 50px" value="{$row->level_position}" type="text" name="level" onkeypress="return isNumberKey(event)" class="m-wrap span12"> 
