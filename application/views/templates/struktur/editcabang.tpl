...
<div class="container-fluid">
    ...
    <div class="row-fluid">
       <div class="span12">
          <h3 class="page-title">
             Edit Divisi
             <small>form isian edit divisi</small>
          </h3>
          <ul class="breadcrumb">
             <li>
                <i class="icon-home"></i>
             ...
             <li>
                <a href="{site_url("struktur/cabang")}">Divisi & Level</a>
                <span class="icon-angle-right"></span>
             </li>
          </ul>
       </div>
                ...
                <div class="tab-pane active">
                   <div class="portlet box blue">
                      <div class="portlet-title">
                         <h4><i class="icon-reorder"></i>Form Edit Divisi</h4>
                         {*<div class="tools">
                      ...
                      <div class="portlet-body form">
                         <!-- BEGIN FORM-->
                         {foreach $list as $row}
                         <form action="{site_url("struktur/editcabang")}/{$row->cabang_id}" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">Nama Divisi</label>
                                <div class="controls">
                                    <input name="cabang" type="text" value="{$row->cabang_nama}" placeholder="nama divisi" class="m-wrap medium" />
                                    <span class="help-block">{ci_form_validation field='cabang' error='true'}</span>
                                </div>
                            </div>
