<?php /* Smarty version Smarty-3.1.13, created on 2013-12-03 11:05:42
         compiled from "application/views/templates/supplier/detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1608519365524a45479fa754-01234286%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19b80a95ed99f0509f2b143bfd9f3e55cf44f110' => 
    array (
      0 => 'application/views/templates/supplier/detail.tpl',
      1 => 1384164000,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1608519365524a45479fa754-01234286',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_524a4547aac8a7_69650113',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_524a4547aac8a7_69650113')) {function content_524a4547aac8a7_69650113($_smarty_tpl) {?><!DOCTYPE html>
...
?>
                         <div class="form-horizontal form-view">
                            ...
                            <div class="row-fluid">
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <span class="text"><?php echo $_smarty_tpl->tpl_vars['row']->value->supplier_company;?>
</span>
                                     </div>
                                  </div>
                               </div>
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <span class="text"><?php echo $_smarty_tpl->tpl_vars['row']->value->supplier_name;?>
</span>
                                     </div>
                                  </div>
                               </div>
                            ...
                            <div class="row-fluid">
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <span class="text"><?php echo $_smarty_tpl->tpl_vars['row']->value->supplier_email;?>
</span> 
                                     </div>
                                  </div>
                               </div>
                            ...
                            <div class="row-fluid">
                               <div class="span12">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <span class="text"><?php echo $_smarty_tpl->tpl_vars['row']->value->supplier_address;?>
</span>
                                     </div>
                                  </div>
                               </div>
                            ...
                            <div class="row-fluid">
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <span class="text"><?php echo $_smarty_tpl->tpl_vars['row']->value->supplier_city;?>
</span>
                                     </div>
                                  </div>
                               </div>
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <span class="text"><?php echo $_smarty_tpl->tpl_vars['row']->value->supplier_telp;?>
</span>
                                     </div>
                                  </div>
                               </div>
                            ...
                            <div class="form-actions">
                                <a href="<?php echo site_url("supplier/edit");?>
