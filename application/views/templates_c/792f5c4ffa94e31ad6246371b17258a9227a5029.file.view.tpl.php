<?php /* Smarty version Smarty-3.1.13, created on 2014-01-24 17:23:27
         compiled from "application/views/templates/user/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:582913714524e7532c65de8-50237783%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '792f5c4ffa94e31ad6246371b17258a9227a5029' => 
    array (
      0 => 'application/views/templates/user/view.tpl',
      1 => 1390559005,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '582913714524e7532c65de8-50237783',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_524e7532eddd90_08637391',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_524e7532eddd90_08637391')) {function content_524e7532eddd90_08637391($_smarty_tpl) {?><!DOCTYPE html>
...
" class="btn red"><i class="icon-pencil"></i> Tambah</a>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="<?php echo site_url("user/excel");?>
...
?>
                            <tr class="odd gradeX">
                                ...
                                <td><?php echo $_smarty_tpl->tpl_vars['row']->value->divisi;?>
</td>
                                <td class="hidden-480"><?php echo $_smarty_tpl->tpl_vars['row']->value->email;?>
</td>
                                <td class="center hidden-480"><?php echo getCabang($_smarty_tpl->tpl_vars['row']->value->cabang_id);?>
</td>
                                <td class="hidden-480"><?php echo $_smarty_tpl->tpl_vars['row']->value->level_desc;?>
 - <?php echo $_smarty_tpl->tpl_vars['row']->value->level_position;?>
</td>
                                <td class="hidden-480"><?php echo $_smarty_tpl->tpl_vars['row']->value->status;?>
</td>
                                <td class="hidden-480">
                                    <a href="<?php echo site_url("user/edit");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->login_id;?>
" onclick="return confirm('Anda yakin mau edit User ini?');">
                                        <img src="<?php echo site_url("assets/img/document_edit.png");?>
" width="20">
                                    </a>&nbsp;&nbsp;&nbsp;
                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->level_position!='0'){?>
                                    <a href="<?php echo site_url("user/delete");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->login_id;?>
" onclick="return confirm('Anda yakin mau hapus User ini ?');">
