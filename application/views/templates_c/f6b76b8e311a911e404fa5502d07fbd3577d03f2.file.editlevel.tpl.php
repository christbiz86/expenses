<?php /* Smarty version Smarty-3.1.13, created on 2013-12-04 10:21:20
         compiled from "application/views/templates/struktur/editlevel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:738562507524e479c1c1145-29542555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6b76b8e311a911e404fa5502d07fbd3577d03f2' => 
    array (
      0 => 'application/views/templates/struktur/editlevel.tpl',
      1 => 1384163999,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '738562507524e479c1c1145-29542555',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_524e479c2df5d0_78236445',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_524e479c2df5d0_78236445')) {function content_524e479c2df5d0_78236445($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
       <div class="span12">
          <h3 class="page-title">
             Edit Leveling
             <small>form isian edit leveling</small>
          </h3>
          <ul class="breadcrumb">
             <li>
                <i class="icon-home"></i>
...
">Cabang & Level</a>
             ...
             <li><a href="<?php echo site_url("struktur/editlevel");?>
">Edit Leveling</a></li>
          </ul>
       </div>
    </div>
                ...
                <div class="tab-pane active">
                   <div class="portlet box blue">
                      <div class="portlet-title">
                         <h4><i class="icon-reorder"></i>Form Edit Leveling</h4>
...
?>
                         <form action="<?php echo site_url("struktur/editlevel");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->level_id;?>
" method="post" class="form-horizontal">
                            <input type="hidden" name="level_old" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->level_position;?>
">
                            <div class="control-group">
                                <label class="control-label">Deskripsi</label>
                                <div class="controls">
                                    <input name="desc" type="text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->level_desc;?>
" placeholder="deskripsi level" class="m-wrap medium" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 50px" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->level_position;?>
" type="text" name="level" onkeypress="return isNumberKey(event)" class="m-wrap span12"> 
