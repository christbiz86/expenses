<?php /* Smarty version Smarty-3.1.13, created on 2014-01-24 11:14:01
         compiled from "application/views/templates/stock/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139159930052689eb0251408-82410527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7102932c173f5de7707c415886f9547d7a82b6d' => 
    array (
      0 => 'application/views/templates/stock/view.tpl',
      1 => 1390534148,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '139159930052689eb0251408-82410527',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52689eb02de6b6_50327788',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_52689eb02de6b6_50327788')) {function content_52689eb02de6b6_50327788($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        <thead>
                            <tr>
                                <th>No</th>
                                <?php $_smarty_tpl->tpl_vars['noid'] = new Smarty_variable(1, null, 0);?>
...
?>
                                <th <?php if ($_smarty_tpl->tpl_vars['noid']->value!=1){?>class="hidden-480"<?php }?>><?php echo $_smarty_tpl->tpl_vars['row']->value->spek_desc_name;?>
</th>
                                <?php $_smarty_tpl->tpl_vars['noid'] = new Smarty_variable($_smarty_tpl->tpl_vars['noid']->value+1, null, 0);?>
                                <?php } ?>
                                <th>Action</th>
                            </tr>
                        </thead>
...
?>
                            <tr>
                                ...
                                <?php $_smarty_tpl->tpl_vars['noid2'] = new Smarty_variable(1, null, 0);?>
                                <?php  $_smarty_tpl->tpl_vars['row'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['row']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['column']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['row']->key => $_smarty_tpl->tpl_vars['row']->value){
$_smarty_tpl->tpl_vars['row']->_loop = true;
?>
                                    <?php $_smarty_tpl->tpl_vars['field'] = new Smarty_variable($_smarty_tpl->tpl_vars['row']->value->spek_desc_name, null, 0);?>
                                <td <?php if ($_smarty_tpl->tpl_vars['noid2']->value!=1){?>class="hidden-480"<?php }?>><?php echo $_smarty_tpl->tpl_vars['data']->value->{$_smarty_tpl->tpl_vars['field']->value};?>
</td>
                                <?php $_smarty_tpl->tpl_vars['noid2'] = new Smarty_variable($_smarty_tpl->tpl_vars['noid2']->value+1, null, 0);?>
                                <?php } ?>
                                <td>
                                    <a href="<?php echo site_url("stock/edit");?>
/<?php echo $_smarty_tpl->tpl_vars['data']->value->stock_id;?>
" onclick="return confirm('Anda yakin mau edit Stock ini?');">
                                        <img src="<?php echo site_url("assets/img/document_edit.png");?>
" width="20">
                                    </a>&nbsp;&nbsp;&nbsp;
                                    <a href="<?php echo site_url("stock/delete");?>
/<?php echo $_smarty_tpl->tpl_vars['data']->value->stock_id;?>
" onclick="return confirm('Anda yakin mau hapus Stock ini?');">
