<?php /* Smarty version Smarty-3.1.13, created on 2014-01-24 11:23:43
         compiled from "application/views/templates/struktur/addcabang.tpl" */ ?>
<?php /*%%SmartyHeaderCode:986638595524e537ba7c244-15837050%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6edb9a5ba0eabcbc739d1f050c5b9b372856fefa' => 
    array (
      0 => 'application/views/templates/struktur/addcabang.tpl',
      1 => 1390537419,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '986638595524e537ba7c244-15837050',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_524e537bbcf897_24207881',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_524e537bbcf897_24207881')) {function content_524e537bbcf897_24207881($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/CM/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
">Cabang & Level</a>
             ...
             <li><a href="<?php echo site_url("struktur/addcabang");?>
">Tambah Divisi</a></li>
          </ul>
       </div>
    </div>
                ...
                <div class="tab-pane active">
                   <div class="portlet box blue">
                      <div class="portlet-title">
                         <h4><i class="icon-reorder"></i>Form Tambah Divisi</h4>
                         
                      </div>
                      <div class="portlet-body form">
                         <!-- BEGIN FORM-->
                         <form action="<?php echo site_url("struktur/addcabang");?>
" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">Nama Divisi</label>
                                <div class="controls">
                                    <input name="cabang" type="text" placeholder="nama divisi" class="m-wrap medium" />
                                    <span class="help-block"><?php echo smarty_function_ci_form_validation(array('field'=>'cabang','error'=>'true'),$_smarty_tpl);?>
</span>
                                </div>
                            </div>
