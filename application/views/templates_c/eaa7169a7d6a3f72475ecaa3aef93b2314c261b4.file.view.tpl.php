<?php /* Smarty version Smarty-3.1.13, created on 2014-01-24 11:13:06
         compiled from "application/views/templates/scan/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:458811710526f21426fe281-46146003%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eaa7169a7d6a3f72475ecaa3aef93b2314c261b4' => 
    array (
      0 => 'application/views/templates/scan/view.tpl',
      1 => 1390534140,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '458811710526f21426fe281-46146003',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_526f21427b7696_92904079',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_526f21427b7696_92904079')) {function content_526f21427b7696_92904079($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12"> 
            ...
            <h3 class="page-title">
                Data Scan
                <small>isi semua data scan dokumen</small>
            </h3>
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
        ...
        <div class="span12">
            ...
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <h4><i class="icon-upload"></i>Data Scan Dokumen</h4>
                    <div class="actions">
                        <a href="<?php echo site_url("scan/add");?>
" class="btn grey"><i class="icon-pencil"></i> Tambah</a>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="<?php echo site_url("scan/excel");?>
...
?>
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="<?php echo site_url("scan/edit");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->scan_id;?>
" onclick="return confirm('Anda yakin mau edit Dokumen ini?');">
                                        <img src="<?php echo site_url("assets/img/document_edit.png");?>
" width="20">
                                    </a>&nbsp;&nbsp;&nbsp;
                                    <a href="<?php echo site_url("scan/delete");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->scan_id;?>
" onclick="return confirm('Anda yakin mau hapus Dokumen ini ?');">
