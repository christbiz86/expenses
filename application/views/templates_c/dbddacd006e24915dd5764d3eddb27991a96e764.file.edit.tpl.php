<?php /* Smarty version Smarty-3.1.13, created on 2014-01-22 09:51:49
         compiled from "application/views/templates/bank/edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:76764769052df2b79839407-92524516%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dbddacd006e24915dd5764d3eddb27991a96e764' => 
    array (
      0 => 'application/views/templates/bank/edit.tpl',
      1 => 1390359104,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '76764769052df2b79839407-92524516',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52df2b79a66881_76496964',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_52df2b79a66881_76496964')) {function content_52df2b79a66881_76496964($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
?>
                         <form action="<?php echo site_url("bank/edit");?>
/<?php echo $_smarty_tpl->tpl_vars['data']->value->bank_id;?>
" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">Nama Bank</label>
                                <div class="controls">
                                    <input name="bank_nama" type="text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->bank_nama;?>
" placeholder="nama bank" class="m-wrap medium" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="bank_norek" type="text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->bank_norek;?>
" placeholder="nomor rekening bank" class="m-wrap medium" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="item_kode" type="text" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->item_kode;?>
" placeholder="kode transaksi" class="m-wrap medium" />
