<?php /* Smarty version Smarty-3.1.13, created on 2013-11-26 14:48:43
         compiled from "application/views/templates/scan/edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1307951487526f380a4e9d65-53875413%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3966df5ed89a7a09c2f041800d61e50698126652' => 
    array (
      0 => 'application/views/templates/scan/edit.tpl',
      1 => 1384163998,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1307951487526f380a4e9d65-53875413',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_526f380a4ea2c6_97055074',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_526f380a4ea2c6_97055074')) {function content_526f380a4ea2c6_97055074($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
?>
                         <form action="<?php echo site_url("scan/edit");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->scan_id;?>
" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="control-group">
                                <label class="control-label">Nama Dokumen</label>
                                <div class="controls">
                                    <input name="nama" type="text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->scan_nama;?>
" placeholder="nama lengkap" class="m-wrap medium" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php $_smarty_tpl->tpl_vars["hasil"] = new Smarty_variable(explode(",",$_smarty_tpl->tpl_vars['row']->value->scan_dokumen), null, 0);?> 
                                    <?php $_smarty_tpl->tpl_vars['no'] = new Smarty_variable(1, null, 0);?>
                                    <?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['hasil']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['data']->key => $_smarty_tpl->tpl_vars['data']->value){
$_smarty_tpl->tpl_vars['data']->_loop = true;
?>
                                        <div class="dok<?php echo $_smarty_tpl->tpl_vars['no']->value;?>
">
                                        <button type="button" id="dokumen" class="dok<?php echo $_smarty_tpl->tpl_vars['no']->value;?>
" style="height: 22px;">Hapus</button> 
                                        <input type="file" name="dokumen[]" value="<?php echo $_smarty_tpl->tpl_vars['data']->value;?>
">
                                        <input type="text" style="display: none" name="dokumen[]" value="<?php echo $_smarty_tpl->tpl_vars['data']->value;?>
">
