<?php /* Smarty version Smarty-3.1.13, created on 2013-11-19 11:57:00
         compiled from "application/views/templates/stock/spek-edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18701479405268cacfcf4b59-32243412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f09b2fad8b96e127309076f4e6971156bb8262e7' => 
    array (
      0 => 'application/views/templates/stock/spek-edit.tpl',
      1 => 1384163999,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18701479405268cacfcf4b59-32243412',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5268cacfcf5199_77619545',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5268cacfcf5199_77619545')) {function content_5268cacfcf5199_77619545($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
?>
                         <!-- BEGIN FORM-->
                         <form action="<?php echo site_url("stock/spekedit");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->spek_desc_id;?>
                            ...
                            <div class="row-fluid">
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <input type="text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->spek_desc_name;?>
" class="m-wrap span12" placeholder="Spesifikasi" name="desc">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn" onclick="location.href='<?php echo site_url('stock/spek');?>
'">Cancel</button>
                            </div>
                         </form>
                         <?php } ?>
