<?php /* Smarty version Smarty-3.1.13, created on 2013-11-19 14:22:16
         compiled from "application/views/templates/changepassword.tpl" */ ?>
<?php /*%%SmartyHeaderCode:96333237452567bc9a756f1-87952230%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '96333237452567bc9a756f1-87952230',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52567bc9a76911_81630459',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_52567bc9a76911_81630459')) {function content_52567bc9a76911_81630459($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box yellow">
                     ...
                     <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo site_url("home/changepassword");?>
" class="form-horizontal" method="post">
                            <?php if ($_smarty_tpl->tpl_vars['password']->value=='lama'){?>
                            <div style="color: #b94a48;padding: 5px">Maaf, Anda salah memasukkan password lama. Silahkan ulangi kembali.</div>
                            <?php }elseif($_smarty_tpl->tpl_vars['password']->value=='beda'){?>
                            <div style="color: #b94a48;padding: 5px">Maaf, password baru Anda tidak sama. Silahkan ulangi kembali.</div>
                            <?php }?>
                            <div class="control-group">
                              <label class="control-label">Current Password</label>
                              <div class="controls">
                                    <input type="password" name="old_password" value="<?php echo smarty_function_ci_form_validation(array('field'=>'old_password'),$_smarty_tpl);?>
" class="span6 m-wrap" />
                                    <span class="help-block"><?php echo smarty_function_ci_form_validation(array('field'=>'old_password','error'=>'true'),$_smarty_tpl);?>
</span>
                              </div>
                           </div>
                           <div class="control-group">
                              ...
                              <div class="controls">
                                    <input type="password" name="new_password" value="<?php echo smarty_function_ci_form_validation(array('field'=>'new_password'),$_smarty_tpl);?>
" class="span6 m-wrap" />
                                    <span class="help-block"><?php echo smarty_function_ci_form_validation(array('field'=>'new_password','error'=>'true'),$_smarty_tpl);?>
</span>
                              </div>
                           </div>
                              <div class="control-group">
                              ...
                              <div class="controls">
                                    <input type="password" name="retype_password" value="<?php echo smarty_function_ci_form_validation(array('field'=>'retype_password'),$_smarty_tpl);?>
" class="span6 m-wrap" />
                                    <span class="help-block"><?php echo smarty_function_ci_form_validation(array('field'=>'retype_password','error'=>'true'),$_smarty_tpl);?>
</span>
                              </div>
                           </div>
