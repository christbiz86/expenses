<?php /* Smarty version Smarty-3.1.13, created on 2014-01-17 14:56:50
         compiled from "application/views/templates/budget/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154559149152561f40139c10-65423866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '69790f325b380110dd952f47074be7a987d32e71' => 
    array (
      0 => 'application/views/templates/budget/add.tpl',
      1 => 1384164001,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '154559149152561f40139c10-65423866',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52561f401f9ca9_22540400',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_52561f401f9ca9_22540400')) {function content_52561f401f9ca9_22540400($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/var/www/html/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
">Budget</a>
             ...
             <li><a href="<?php echo site_url("budget/add");?>
">Tambah Budget</a></li>
          </ul>
       </div>
    </div>
                ...
                <div class="tab-pane active">
                   <div class="portlet box blue">
                      ...
                      <div class="portlet-body form">
                         <!-- BEGIN FORM-->
                         <form action="<?php echo site_url("budget/add");?>
" method="post" class="form-horizontal">
                            <?php if ($_smarty_tpl->tpl_vars['error']->value=='over'){?>
...
?>
                                    <input type="checkbox" name="cabang[]" value="<?php echo $_smarty_tpl->tpl_vars['row']->value->cabang_id;?>
...
?>
                                        <option value="<?php echo $_smarty_tpl->tpl_vars['list']->value->item_id;?>
"><?php echo $_smarty_tpl->tpl_vars['list']->value->item_desc;?>
</option>
                                        <?php } ?>
                                    </select>
                                </div>
...
" placeholder="jumlah budget" class="m-wrap medium" name="jumlah" onkeyup="ubahharga()" onkeypress="return isNumberKey(event)" />
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn" onclick="location.href='<?php echo site_url('budget');?>
'">Cancel</button>
                            </div>
                         </form>
                         <!-- END FORM-->                
