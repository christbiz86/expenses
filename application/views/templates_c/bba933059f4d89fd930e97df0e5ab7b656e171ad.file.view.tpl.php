<?php /* Smarty version Smarty-3.1.13, created on 2014-01-24 11:14:10
         compiled from "application/views/templates/libur/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:619814913525f984180c384-89979287%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bba933059f4d89fd930e97df0e5ab7b656e171ad' => 
    array (
      0 => 'application/views/templates/libur/view.tpl',
      1 => 1390534126,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '619814913525f984180c384-89979287',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_525f984180c840_00969660',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_525f984180c840_00969660')) {function content_525f984180c840_00969660($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="span12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="<?php echo site_url("libur/request");?>
" class="btn red"><i class="icon-pencil"></i> Tambah</a>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="<?php echo site_url("libur/excel");?>
...
?>
                            <tr>
                                ...
                                <td><?php echo showDate($_smarty_tpl->tpl_vars['row']->value->libur_start);?>
 - <?php echo showDate($_smarty_tpl->tpl_vars['row']->value->libur_end);?>
</td>
                                <td class="hidden-480"><?php echo $_smarty_tpl->tpl_vars['row']->value->uraian;?>
</td>
                                <td class="hidden-480"><?php echo $_smarty_tpl->tpl_vars['row']->value->full_name;?>
</td>
                                <td>
                                    <?php if ($_smarty_tpl->tpl_vars['row']->value->user_ganti!=$_smarty_tpl->tpl_vars['id']->value){?>
                                        <?php echo $_smarty_tpl->tpl_vars['row']->value->status;?>

                                        <?php if ($_smarty_tpl->tpl_vars['row']->value->status!='New'){?>
                                            - <?php echo showDate($_smarty_tpl->tpl_vars['row']->value->approved_date);?>

                                        <?php }else{ ?>
                                            &nbsp;&nbsp;&nbsp;<a href="<?php echo site_url("libur/cancel");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->libur_id;?>
" onclick="return confirm('Anda yakin mau cancel Permintaan Cuti ini?');">
                                                <span style="cursor: pointer" class="label label-warning">Cancel</span>
                                            </a>
                                        <?php }?>
                                    <?php }else{ ?>
                                        <?php if ($_smarty_tpl->tpl_vars['row']->value->status=='New'){?>
                                        &nbsp;&nbsp;&nbsp;<a href="<?php echo site_url("libur/accept");?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value->libur_id;?>
" onclick="return confirm('Anda yakin mau approve Permintaan Cuti ini?');">
                                            <span style="cursor: pointer" class="label label-success">Approve</span>
                                        </a>
                                        <?php }else{ ?>
                                        Approved - <?php echo showDate($_smarty_tpl->tpl_vars['row']->value->approved_date);?>
