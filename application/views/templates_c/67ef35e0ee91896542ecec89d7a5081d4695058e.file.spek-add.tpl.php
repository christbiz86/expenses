<?php /* Smarty version Smarty-3.1.13, created on 2013-10-24 10:43:06
         compiled from "application/views/templates/stock/spek-add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9345754695268d0a79b85f9-49596088%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67ef35e0ee91896542ecec89d7a5081d4695058e' => 
    array (
      0 => 'application/views/templates/stock/spek-add.tpl',
      1 => 1382602830,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9345754695268d0a79b85f9-49596088',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5268d0a7a5e2c9_71944499',
  'variables' => 
  array (
    'nama' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5268d0a7a5e2c9_71944499')) {function content_5268d0a7a5e2c9_71944499($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ci_form_validation')) include '/opt/lampp/htdocs/sellexpense/system/libraries/smarty/libs/plugins/function.ci_form_validation.php';
?><!DOCTYPE html>
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
       <div class="span12">
          <h3 class="page-title">
             Tambah Spesifikasi
             <small>form isian tambah spesifikasi</small>
          </h3>
          <ul class="breadcrumb">
             <li>
                <i class="icon-home"></i>
...
">Home</a> 
             ...
             <li>
                <a href="<?php echo site_url("stock/spek");?>
">Data Spesifikasi</a>
             </li>
          </ul>
       </div>
                ...
                <div class="tab-pane active">
                   <div class="portlet box green">
                      <div class="portlet-title">
                         <h4><i class="icon-reorder"></i>Form Tambah Spesifikasi</h4>
                         <div class="tools">
                      ...
                      <div class="portlet-body form">
                         <!-- BEGIN FORM-->
                         <form action="<?php echo site_url("stock/spekadd");?>
                            ...
                            <div class="row-fluid">
                               <div class="span6">
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
                                        <input type="text" value="<?php echo smarty_function_ci_form_validation(array('field'=>'desc'),$_smarty_tpl);?>
" class="m-wrap span12" placeholder="Spesifikasi" name="desc">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn" onclick="location.href='<?php echo site_url('stock');?>
'">Cancel</button>
                            </div>
                         </form>
                         <!-- END FORM-->                
